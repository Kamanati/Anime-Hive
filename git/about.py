...
- Supports filter and advanced filter options
- Open source and free to use
- Customizable and easy to modify code

Installation:
1. Clone or download the source code from the GitHub repository
2. Install the required dependencies using pip:
   pip install -r requirements.txt
3. pip install anime-scope

Usage:
1. Run the main.py script in your terminal:
   python main.py or anime-scope 
2. Follow the prompts to enter your search criteria and select your desired filters
...
Contact:
[-] If you have any questions or feedback about the project, you can contact the author at hasanfq818@gmail.com.
[-] Sends email notifications to the author (hasanfq818@gmail.com) for feedback and suggestions
